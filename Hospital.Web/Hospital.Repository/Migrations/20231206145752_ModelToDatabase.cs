    ...
    public partial class ModelToDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatietReports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PatietReports_AspNetUsers_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PatietReports_AspNetUsers_PatientId",
                        column: x => x.PatientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PrescribedMedicines_PatietReports_PatientReportId",
                        column: x => x.PatientReportId,
                        principalTable: "PatietReports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatietReports_DoctorId",
                table: "PatietReports",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_PatietReports_PatientId",
                table: "PatietReports",
                column: "PatientId");
