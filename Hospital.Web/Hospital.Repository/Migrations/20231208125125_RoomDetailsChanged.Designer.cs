...
namespace Hospital.Repository.Migrations
{
    ...
    [Migration("20231208125125_RoomDetailsChanged")]
    partial class RoomDetailsChanged
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hospital.Utilities.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hospital.Utilities.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hospital.Utilities.Payroll", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hospital.Utilities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Hospital.Models.Bill", b =>
                {
                    ...
                    b.HasOne("Hospital.Utilities.ApplicationUser", "Patient")
                        .WithMany()
            ...
            modelBuilder.Entity("Hospital.Models.Contact", b =>
                {
                    b.HasOne("Hospital.Models.Hospitals", "Hospital")
                        .WithMany("contacts")
            ...
            modelBuilder.Entity("Hospital.Models.PatientReport", b =>
                {
                    b.HasOne("Hospital.Utilities.ApplicationUser", "Doctor")
                        .WithMany()
            ...
            modelBuilder.Entity("Hospital.Utilities.Payroll", b =>
                {
                    b.HasOne("Hospital.Utilities.ApplicationUser", "EmployeeId")
                        .WithMany("Payrolls")
            ...
            modelBuilder.Entity("Hospital.Utilities.ApplicationUser", b =>
                {
                    b.HasOne("Hospital.Utilities.Department", "Department")
                        .WithMany("Employees")
